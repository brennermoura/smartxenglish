    ...
    <>
      ...
      <div className="container max-w-7xl mx-auto py-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          um verbo e uma partícula (preposição ou advérbio) que, juntos,
          adquirem um significado diferente do verbo original. No mercado de
          trabalho atual, dominar essas expressões é crucial para uma
          comunicação eficaz e natural em inglês.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Fluência e confiança:</strong> Demonstram domínio da língua
            e profissionalismo.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Aprender e praticar:</strong> Estudar phrasal verbs comuns
        ...
        <p className="mb-2">
          🔹 "We need to <strong>come up with</strong> a new marketing
          strategy." (Precisamos criar uma nova estratégia de marketing).
        </p>
        <p className="mb-4">
        ...
        <p>
          Os phrasal verbs são uma ferramenta poderosa para qualquer
          profissional que deseje se comunicar de forma eficaz em inglês no
          mercado global. Para aumentar a fluência e acessar mais oportunidades,
          é essencial praticar e incorporar essas expressões ao dia a dia
          profissional.
        </p>
        <div className="mt-5">
          <Link
