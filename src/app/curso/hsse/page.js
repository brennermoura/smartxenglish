...
export default function HSSE() {
  return (
    <div className="container max-w-7xl mx-auto py-10 text-gray-800">
      ...
      <p className="mb-4">
        O <strong>HSSE</strong> (Health, Safety, Security, and Environment) é um
        framework que integra a gestão da saúde, segurança, segurança física e
        meio ambiente em uma organização. Ele é amplamente adotado em setores
        como energia, construção e manufatura.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Importância do HSSE</h2>
      <ul className="list-disc list-inside mb-4">
        <li>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>
          <strong>Desenvolvimento de políticas:</strong> Diretrizes claras para
      ...
      <p>
        O HSSE é essencial para garantir segurança, saúde e sustentabilidade em
        qualquer organização. Ao implementar um sistema HSSE eficaz, as empresas
        podem minimizar riscos, melhorar a conformidade regulatória e promover
