  ...
  return (
    <>
      ...
      <div className="container max-w-7xl mx-auto py-10 text-gray-800 px-5 md:px-0 mt-20">
        ...
        <p className="mb-4">
          O <strong>NORMAM</strong> (Normas da Autoridade Marítima) é um
          conjunto de regulamentações estabelecidas pela Marinha do Brasil para
          garantir a segurança, a eficiência e a conformidade legal nas
          operações marítimas e portuárias no Brasil.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            marítimas no Brasil estejam em conformidade com a legislação
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            ...
            garantindo que sua embarcação esteja em conformidade com os padrões
            de segurança.
          </li>
          <li>
            ...
            procedimentos adequados para evitar riscos ambientais e de
            segurança.
          </li>
        </ul>
        ...
        <p>
          ...
          normas, as empresas e operadores podem minimizar riscos, proteger o
          meio ambiente e cumprir com as exigências legais.
        </p>
