    ...
    <>
      ...
      <div className="container max-w-7xl mx-auto py-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          atualizados várias vezes, sendo a versão mais recente os INCOTERMs
          2020.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>EXW (Ex Works):</strong> O comprador assume todos os custos
            e riscos desde a fábrica do vendedor.
          </li>
          <li>
            <strong>FOB (Free on Board):</strong> O vendedor entrega a
            mercadoria no porto de embarque, e o comprador assume os custos e
            riscos subsequentes.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Padronização internacional:</strong> Facilitam a comunicação
            e a negociação em transações globais.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Escolha do INCOTERM adequado:</strong> Selecionar o termo
            que melhor se adapta às necessidades específicas da transação.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Exemplo 1:</strong> Uma empresa brasileira exporta café para
            a Europa sob o termo FOB. O vendedor entrega a mercadoria no porto
            de Santos, e o comprador assume os custos e riscos subsequentes.
          </li>
          <li>
            <strong>Exemplo 2:</strong> Uma importadora chinesa compra
            eletrônicos sob o termo CIF. O vendedor paga o frete e seguro até o
            porto de destino, mas o comprador assume os riscos após a entrega no
            porto.
          </li>
        </ul>
        ...
        <p>
          ...
          simplificam a comunicação entre compradores e vendedores, reduzem
          riscos e garantem clareza contratual. Ao escolher e aplicar
          corretamente os INCOTERMs, as empresas podem evitar mal-entendidos e
          otimizar suas operações de exportação e importação.
        </p>
