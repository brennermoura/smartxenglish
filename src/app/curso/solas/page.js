  ...
  return (
    <div className="container max-w-7xl mx-auto py-10 text-gray-800">
      ...
      <p className="mb-4">
        ...
        estabelece padrões mínimos de segurança para a construção, equipamento e
        operação de navios mercantes.
      </p>
      ...
      <p className="mb-4">
        ...
        1974, entrou em vigor em 1980 e continua sendo atualizada para refletir
        avanços tecnológicos e novas preocupações de segurança.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          <strong>Capítulo II:</strong> Construção de navios, incluindo proteção
          contra incêndios.
        </li>
        <li>
          <strong>Capítulo III:</strong> Equipamentos de salvamento, como botes
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Importância do SOLAS</h2>
      <ul className="list-disc list-inside mb-4">
        <li>
          <strong>Segurança de vidas:</strong> Redução de riscos em emergências
          marítimas.
        </li>
        <li>
        ...
        <li>
          <strong>Proteção ambiental:</strong> Prevenção de vazamentos de óleo e
          poluição marinha.
        </li>
      </ul>
      ...
      <p>
        ...
        operações seguras, redução de acidentes e proteção ambiental. Ao seguir
        suas diretrizes, a indústria marítima se torna mais eficiente e segura.
      </p>
      <div className="mt-5">
        <Link
          href="/#cursos"
