...
export default function IELTS() {
  return (
    <div className="container max-w-7xl mx-auto py-10 text-gray-800">
      ...
      <p className="mb-4">
        O <strong>IELTS</strong> (International English Language Testing System)
        é um exame amplamente reconhecido para avaliar a proficiência em inglês,
        dividido em quatro seções: <strong>Listening, Reading, Writing</strong>{" "}
        e <strong>Speaking</strong>.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">O que é o IELTS?</h2>
      <p className="mb-4">
        Criado em 1989, o IELTS avalia a capacidade prática de usar o idioma em
        situações do dia a dia. Aceito por mais de 12.500 organizações em cerca
        de 140 países, é utilizado por universidades, empregadores e autoridades
        de imigração.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          <strong>Speaking (11-14 minutos):</strong> Entrevista face a face com
          examinador.
        </li>
      </ul>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Importância do IELTS</h2>
      <ul className="list-disc list-inside mb-4">
        <li>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          <strong>Aprimorar vocabulário:</strong> Enriquecer o léxico em inglês
          com leituras e escuta ativa.
        </li>
        <li>
      ...
      <p className="mb-2">
        🔹 Um estudante que deseja cursar mestrado no Reino Unido precisa de uma
        pontuação mínima de <strong>6.5</strong> no IELTS Academic.
      </p>
      <p className="mb-4">
