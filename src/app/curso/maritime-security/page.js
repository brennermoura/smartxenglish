  ...
  return (
    <>
      ...
      <div className="container max-w-7xl mx-auto py-10 text-gray-800">
        ...
        <p className="mb-4">
          A <strong>Maritime Security</strong> refere-se às medidas e
          estratégias implementadas para proteger embarcações, portos e
          infraestruturas marítimas contra ameaças.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Cooperação internacional:</strong> Promove a colaboração
            entre governos e organizações para enfrentar desafios marítimos.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Vigilância e inteligência:</strong> Monitorar tráfego
            marítimo e compartilhar informações com agências de aplicação da
            lei.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Exemplo 2:</strong> Em portos, medidas de segurança incluem
            a instalação de sistemas de vigilância eletrônica e a realização de
        ...
        <p>
          ...
          garantir a segurança das rotas comerciais e prevenir atividades
          ilícitas no mar. Com medidas eficazes, as nações promovem o comércio
          seguro, protegem o meio ambiente e fortalecem a cooperação
          internacional.
        </p>
